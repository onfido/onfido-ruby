...
module Onfido
  class SdkTokenBuilder
    ...
    attr_accessor :cross_device_url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::SdkTokenBuilder` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Onfido::SdkTokenBuilder`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cross_device_url')
        self.cross_device_url = attributes[:'cross_device_url']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cross_device_url == o.cross_device_url
    end
    ...
    def hash
      [applicant_id, referrer, application_id, cross_device_url].hash
    end
