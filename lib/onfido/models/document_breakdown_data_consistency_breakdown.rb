...
module Onfido
  class DocumentBreakdownDataConsistencyBreakdown
    ...
    attr_accessor :multiple_data_sources_present
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownDataConsistencyBreakdown` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Onfido::DocumentBreakdownDataConsistencyBreakdown`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'document_numbers')
        self.document_numbers = attributes[:'document_numbers']
      end
      ...
      if attributes.key?(:'multiple_data_sources_present')
        self.multiple_data_sources_present = attributes[:'multiple_data_sources_present']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          multiple_data_sources_present == o.multiple_data_sources_present
    end
    ...
    def hash
      [date_of_expiry, document_numbers, issuing_country, document_type, date_of_birth, gender, first_name, nationality, last_name, multiple_data_sources_present].hash
    end
