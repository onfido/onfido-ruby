...
module Onfido
  class DocumentODPReasons
    ...
    attr_accessor :document_on_printed_paper
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentODPReasons` initialize method"
      end
      ...
      if attributes.key?(:'photo_of_screen')
        self.photo_of_screen = attributes[:'photo_of_screen']
      end
      ...
      if attributes.key?(:'document_on_printed_paper')
        self.document_on_printed_paper = attributes[:'document_on_printed_paper']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          photo_of_screen == o.photo_of_screen &&
          screenshot == o.screenshot &&
          document_on_printed_paper == o.document_on_printed_paper &&
          scan == o.scan
    end
    ...
    def hash
      [photo_of_screen, screenshot, document_on_printed_paper, scan].hash
    end
