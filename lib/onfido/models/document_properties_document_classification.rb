  ...
  class DocumentPropertiesDocumentClassification
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentPropertiesDocumentClassification` initialize method"
      end
    ...
    def hash
      [issuing_country, document_type, issuing_state].hash
    end
