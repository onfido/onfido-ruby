...
module Onfido
  class RepeatAttemptsList
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Onfido::RepeatAttemptsList`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] repeat_attempts Value to be assigned
    def repeat_attempts=(repeat_attempts)
      if repeat_attempts.nil?
        fail ArgumentError, 'repeat_attempts cannot be nil'
      end
