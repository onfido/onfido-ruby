...
module Onfido
  class DocumentPropertiesDocumentNumbersInner
    attr_accessor :value
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentPropertiesDocumentNumbersInner` initialize method"
      end
