...
module Onfido
  ...
  class DocumentBreakdownImageIntegrityBreakdownSupportedDocument
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownImageIntegrityBreakdownSupportedDocument` initialize method"
      end
