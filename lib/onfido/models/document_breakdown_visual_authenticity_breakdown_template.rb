...
module Onfido
  ...
  class DocumentBreakdownVisualAuthenticityBreakdownTemplate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownVisualAuthenticityBreakdownTemplate` initialize method"
      end
