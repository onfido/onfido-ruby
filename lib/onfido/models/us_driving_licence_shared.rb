...
module Onfido
  ...
  class UsDrivingLicenceShared
    ...
    def valid?
      ...
      document_category_validator = EnumAttributeValidator.new('String', ["driver license", "driver permit", "id card"])
      return false unless document_category_validator.valid?(@document_category)
      eye_color_code_validator = EnumAttributeValidator.new('String', ["BLK", "BLU", "BRO", "DIC", "GRY", "GRN", "HAZ", "MAR", "PNK"])
    ...
    def document_category=(document_category)
      validator = EnumAttributeValidator.new('String', ["driver license", "driver permit", "id card"])
    ...
    def eye_color_code=(eye_color_code)
      validator = EnumAttributeValidator.new('String', ["BLK", "BLU", "BRO", "DIC", "GRY", "GRN", "HAZ", "MAR", "PNK"])
