  ...
  class ApplicantBuilder
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::ApplicantBuilder` initialize method"
      end
    ...
    def valid?
      ...
      return false if @first_name !~ Regexp.new(/^[^!#$%*=<>;{}"]*$/)
      return false if @last_name.nil?
      return false if @last_name !~ Regexp.new(/^[^!#$%*=<>;{}"]*$/)
      true
    end
