...
module Onfido
  ...
  class DocumentBreakdownVisualAuthenticityBreakdownOriginalDocumentPresent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownVisualAuthenticityBreakdownOriginalDocumentPresent` initialize method"
      end
