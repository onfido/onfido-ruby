  ...
  class BiometricTokenData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::BiometricTokenData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Onfido::BiometricTokenData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["awaiting_input", "processing", "error", "abandoned", "review", "declined", "approved", "unknown_default_open_api"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["awaiting_input", "processing", "error", "abandoned", "review", "declined", "approved", "unknown_default_open_api"])
    ...
    def hash
      [inserted_at, media_type, status].hash
    end
