...
module Onfido
  ...
  class DocumentBreakdownImageIntegrityBreakdownImageQuality
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownImageIntegrityBreakdownImageQuality` initialize method"
      end
