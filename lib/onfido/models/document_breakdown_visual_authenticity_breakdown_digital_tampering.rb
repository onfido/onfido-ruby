...
module Onfido
  ...
  class DocumentBreakdownVisualAuthenticityBreakdownDigitalTampering
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownVisualAuthenticityBreakdownDigitalTampering` initialize method"
      end
