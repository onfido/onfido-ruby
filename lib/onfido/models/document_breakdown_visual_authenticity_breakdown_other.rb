...
module Onfido
  ...
  class DocumentBreakdownVisualAuthenticityBreakdownOther
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownVisualAuthenticityBreakdownOther` initialize method"
      end
