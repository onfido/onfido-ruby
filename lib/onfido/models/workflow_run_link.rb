...
module Onfido
  class WorkflowRunLink
    ...
    attr_accessor :completed_redirect_url
    ...
    attr_accessor :expired_redirect_url
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Onfido::WorkflowRunLink`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'completed_redirect_url')
        self.completed_redirect_url = attributes[:'completed_redirect_url']
      end

      if attributes.key?(:'expired_redirect_url')
        self.expired_redirect_url = attributes[:'expired_redirect_url']
      end
    ...
    def valid?
      ...
      language_validator = EnumAttributeValidator.new('String', ["en_US", "de_DE", "es_ES", "fr_FR", "it_IT", "pt_PT", "nl_NL", "unknown_default_open_api"])
    ...
    def language=(language)
      validator = EnumAttributeValidator.new('String', ["en_US", "de_DE", "es_ES", "fr_FR", "it_IT", "pt_PT", "nl_NL", "unknown_default_open_api"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          url == o.url &&
          completed_redirect_url == o.completed_redirect_url &&
          expired_redirect_url == o.expired_redirect_url &&
    ...
    def hash
      [url, completed_redirect_url, expired_redirect_url, expires_at, language].hash
    end
