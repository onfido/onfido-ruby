...
module Onfido
  class WorkflowRunResponse
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["awaiting_input", "processing", "abandoned", "error", "approved", "review", "declined"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["awaiting_input", "processing", "abandoned", "error", "approved", "review", "declined"])
