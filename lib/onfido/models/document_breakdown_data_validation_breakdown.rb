...
module Onfido
  class DocumentBreakdownDataValidationBreakdown
    ...
    attr_accessor :document_expiration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Onfido::DocumentBreakdownDataValidationBreakdown` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Onfido::DocumentBreakdownDataValidationBreakdown`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'document_expiration')
        self.document_expiration = attributes[:'document_expiration']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          document_expiration == o.document_expiration &&
    ...
    def hash
      [gender, date_of_birth, document_numbers, document_expiration, expiry_date, mrz, barcode].hash
    end
