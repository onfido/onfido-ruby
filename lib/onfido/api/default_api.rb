  ...
  class DefaultApi
    ...
    def find_biometric_token_with_http_info(user_id, token_uuid, opts = {})
      ...
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling DefaultApi.find_biometric_token"
      end
      # verify the required parameter 'token_uuid' is set
      if @api_client.config.client_side_validation && token_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'token_uuid' when calling DefaultApi.find_biometric_token"
      end
      # resource path
      local_var_path = '/biometric_tokens/{user_id}/{token_uuid}'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s)).sub('{' + 'token_uuid' + '}', CGI.escape(token_uuid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.find_biometric_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#find_biometric_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def invalidate_biometric_token_with_http_info(user_id, token_uuid, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling DefaultApi.invalidate_biometric_token"
      end
      # verify the required parameter 'token_uuid' is set
      if @api_client.config.client_side_validation && token_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'token_uuid' when calling DefaultApi.invalidate_biometric_token"
      end
      # resource path
      local_var_path = '/biometric_tokens/{user_id}/{token_uuid}'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s)).sub('{' + 'token_uuid' + '}', CGI.escape(token_uuid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.invalidate_biometric_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#invalidate_biometric_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def invalidate_biometric_tokens_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling DefaultApi.invalidate_biometric_tokens"
      end
      # resource path
      local_var_path = '/biometric_tokens/{user_id}'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.invalidate_biometric_tokens",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#invalidate_biometric_tokens\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_biometric_tokens_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling DefaultApi.list_biometric_tokens"
      end
      # resource path
      local_var_path = '/biometric_tokens/{user_id}'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.list_biometric_tokens",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#list_biometric_tokens\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_biometric_token_with_http_info(user_id, token_uuid, biometric_token_updater, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling DefaultApi.update_biometric_token"
      end
      # verify the required parameter 'token_uuid' is set
      if @api_client.config.client_side_validation && token_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'token_uuid' when calling DefaultApi.update_biometric_token"
      end
      # verify the required parameter 'biometric_token_updater' is set
      if @api_client.config.client_side_validation && biometric_token_updater.nil?
        fail ArgumentError, "Missing the required parameter 'biometric_token_updater' when calling DefaultApi.update_biometric_token"
      end
      # resource path
      local_var_path = '/biometric_tokens/{user_id}/{token_uuid}'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s)).sub('{' + 'token_uuid' + '}', CGI.escape(token_uuid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.update_biometric_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#update_biometric_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
