...
require 'onfido/models/device_intelligence_properties_device'
require 'onfido/models/device_intelligence_properties_geolocation'
require 'onfido/models/device_intelligence_properties_ip'
...
require 'onfido/models/document_properties_with_driving_licence_information'
...
require 'onfido/models/passkey'
require 'onfido/models/passkey_updater'
require 'onfido/models/passkeys_list'
...
require 'onfido/models/signing_document'
require 'onfido/models/signing_document_response'
require 'onfido/models/signing_document_shared'
require 'onfido/models/signing_documents_list'
...
require 'onfido/models/watchlist_mesh_added_mentions'
require 'onfido/models/watchlist_mesh_alert_risk'
require 'onfido/models/watchlist_mesh_alert_risk1'
require 'onfido/models/watchlist_mesh_associate'
require 'onfido/models/watchlist_mesh_date_value'
require 'onfido/models/watchlist_mesh_field'
require 'onfido/models/watchlist_mesh_image'
require 'onfido/models/watchlist_mesh_lists'
require 'onfido/models/watchlist_mesh_media'
require 'onfido/models/watchlist_mesh_name'
require 'onfido/models/watchlist_mesh_pep'
require 'onfido/models/watchlist_mesh_person'
require 'onfido/models/watchlist_mesh_profile'
require 'onfido/models/watchlist_mesh_risk_decision'
require 'onfido/models/watchlist_mesh_risk_detail'
require 'onfido/models/watchlist_mesh_risk_indicators'
require 'onfido/models/watchlist_mesh_sanctions'
...
require 'onfido/models/webhook_event_resource_status'
